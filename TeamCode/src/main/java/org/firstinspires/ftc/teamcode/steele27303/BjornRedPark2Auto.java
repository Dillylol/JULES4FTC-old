...
@Autonomous(name = "Bjorn Red Park 2 Auto", group = "Test")
public class BjornRedPark2Auto extends OpMode {
    ...
    public void init() {
        ...
        // Setting start pose to match the start of Path10 (111, 138) with 0 deg heading
        ...
        telemetry.addLine("Bjorn Red Park 2 Auto Initialized");
        telemetry.update();
    }
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 2:
                if (!follower.isBusy()) {
                    setPathState(3);
                    telemetry.addLine("Path 2 Complete");
                }
                break;
            case 3:
                // End state
