...
@Autonomous(name = "farParkAutoRed")
public class FarParkAutoRed extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("Far Park Auto Red Initialized");
        telemetry.update();
    }
