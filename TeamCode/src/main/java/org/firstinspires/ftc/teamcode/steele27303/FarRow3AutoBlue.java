...
@Autonomous(name = "farRow3AutoBlue")
public class FarRow3AutoBlue extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("Far Row 3 Auto Blue Initialized");
        telemetry.update();
    }
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 4:
                ...
                if (Math.hypot(follower.getPose().getX() - 30.0, follower.getPose().getY() - 39.0) < 10.0) {
                    shooter.setIntakePower(true);
                } else {
                    shooter.setIntakePower(false);
                }
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            row2shootrow3approach = follower.pathBuilder().addPath(
                    new BezierCurve(
                            new Pose(57.000, 99.000),
                            new Pose(60.000, 42.000),
                            new Pose(55.000, 39.000)))
